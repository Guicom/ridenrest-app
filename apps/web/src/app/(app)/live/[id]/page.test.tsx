...
let mockStages: { id: string; name: string; endKm: number; startKm: number; color: string; orderIndex: number; adventureId: string; distanceKm: number; elevationGainM: null; elevationLossM: null; etaMinutes: null; departureTime: null; createdAt: string; updatedAt: string }[] = []
...
describe('LivePage — Stage update dialog (AC #3)', () => {
  ...
  it('onStageLongPress opens dialog with stage name', () => {
    mockStages = [
      { id: 'stage-1', name: 'Étape 1', endKm: 25, startKm: 0, color: '#FF0000', orderIndex: 0, adventureId: 'adv-123', distanceKm: 25, elevationGainM: null, elevationLossM: null, etaMinutes: null, departureTime: null, createdAt: '', updatedAt: '' },
    ]
    mockUseLiveMode.mockReturnValue(defaultLiveMode({ hasConsented: true, isLiveModeActive: true }))
    render(<LivePage />)
