  ...
  return (
    <div className="flex h-full w-full">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0">
        ...
        <div className={`hidden lg:block relative w-full shrink-0 border-t border-[--border] bg-background transition-all duration-200 ${elevationCollapsed ? 'h-0' : 'h-[180px]'}`}>
