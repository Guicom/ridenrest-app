...
Use this skill when the user asks to run the migrated source command `agent-vibes-learn`.

## Command Template

Turn language learning mode ON or OFF. When enabled, Codex will speak acknowledgments and completions in BOTH your main language and target language.
