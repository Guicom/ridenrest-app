...
- 2026-03-22 (story 8.8): `<DensityLegend>` supprimée de `map-view.tsx` (overlay flottant bottom-right devenu redondant — la légende est désormais accessible via `SidebarDensitySection` dans le panneau latéral).
